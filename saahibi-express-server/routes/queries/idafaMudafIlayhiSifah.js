...
function findIdafaMudafIlayhiSifahPatterns(records) {
...
router.get('/', async (req, res, next) => {
  try {
    ...
    const patterns = findIdafaMudafIlayhiSifahPatterns(records);
        ...
        beforeInterlude: [
          {
            type: 'text',
            content: `
            <h3>Idafa: Mudaf + Mudaf Ilayhi + Sifah of Mudaf Ilayhi (Pattern ${index + 1})</h3>
            <div class="bg-sky-50 p-4 rounded-lg my-4">
              <h4 class="font-bold text-sky-900 text-lg mb-3">مضاف + مضاف إليه + صفة المضاف إليه</h4>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div class="bg-amber-50 p-3 rounded border-2 border-dashed border-amber-300">
                  <h5 class="font-bold text-amber-800 mb-1">المضاف إليه (موصوف)</h5>
                ...
                <div class="bg-blue-50 p-3 rounded border-2 border-dashed border-blue-300">
                  <h5 class="font-bold text-blue-800 mb-1">صفة المضاف إليه</h5>
